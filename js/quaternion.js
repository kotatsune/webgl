...
Quat.yawPitchRollRotation = function ( yaw, pitch, roll, dest )
{
	...
	var y = yaw   * PI_OVER_180 / 2.0,
		p = pitch * PI_OVER_180 / 2.0,
		r = roll  * PI_OVER_180 / 2.0;
...
Quat.extractAxisAngle = function ( quat )
{
	...
	var scale = sqrt( x * x + y * y + z * z );
	
	return { axis : [ x / scale, y / scale, z / scale ], rad : Math.acos( w ) * 2.0 };
};
