...
// X 軸回転行列を作成します。
//--------------------------------------------------------------------------------
Mat4.rotateX = function ( rad, dest )
{
...
// X 軸回転行列を掛けます。
//--------------------------------------------------------------------------------
Mat4.multiplyRotateX = function ( mat, rad, dest )
{
	// TO DO !!
};
...
// Y 軸回転行列を作成します。
//--------------------------------------------------------------------------------
Mat4.rotateY = function ( rad, dest )
{
	// ちなみに 3x3 の回転行列の逆行列は転置行列です。
...
// Y 軸回転行列を掛けます。
//--------------------------------------------------------------------------------
Mat4.multiplyRotateY = function ( mat, rad, dest )
{
	// TO DO !!
};
...
// Z 軸回転行列を作成します。
//--------------------------------------------------------------------------------
Mat4.rotateZ = function ( rad, dest )
{
	// ちなみに 3x3 の回転行列の逆行列は転置行列です。
...
// Z 軸回転行列を掛けます。
//--------------------------------------------------------------------------------
Mat4.multiplyRotateZ = function ( mat, rad, dest )
{
	// TO DO !!
};
...
// 平行移動行列を作成します。
//--------------------------------------------------------------------------------
Mat4.translate = function ( vec, dest )
{
	if ( !dest )
	{
		dest = Mat4.create();
